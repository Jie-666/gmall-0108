...
public class AttrController {
    ...
    public ResponseVo<List<AttrEntity>> queryAttrsByCidOrTypeOrSearchType(@PathVariable("cid")
                                                                                  Long cid,
    ...
    public ResponseVo<List<AttrEntity>> queryAttesByGid(@PathVariable("gid") Long gid) {
